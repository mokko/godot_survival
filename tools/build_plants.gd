...
## Run: cd project && snap run godot-4 --headless --script res://tools/build_plants.gd
...
const PLAN := {
	...
	"sunbulb": {"scene": "res://flora/sunbulb.tscn", "mode": "biome",
		"placements": [["anywhere", 60]], "inland": true},
	"lantern_reed": {"scene": "res://flora/lantern_reed.tscn", "mode": "biome",
		"placements": [["wetlands", 60], ["caldera_rim", 20]]},
	"mirrorlily_big": {"scene": "res://flora/mirrorlily.tscn", "mode": "biome",
		"placements": [["lake", 12]]},
	"mirrorlily_small": {"scene": "res://flora/mirrorlily_small.tscn", "mode": "biome",
		"placements": [["lake", 13]]},
	"glasspetal": {"scene": "res://flora/glasspetal.tscn", "mode": "biome",
		"placements": [["massif", 20], ["ne_cape", 20]]},
	"embermoss": {"scene": "res://flora/embermoss.tscn", "mode": "biome",
		"placements": [["wetlands", 30], ["massif", 20]]},
	"thornlash": {"scene": "res://flora/thornlash.tscn", "mode": "biome",
		"placements": [["sw_cape", 10], ["wetlands", 5], ["anywhere", 5]], "inland": true},
	"sporebell": {"scene": "res://flora/sporebell.tscn", "mode": "biome",
		"placements": [["wetlands", 20], ["ne_cape", 10]]},
	"hoverfern": {"scene": "res://flora/hoverfern.tscn", "mode": "biome",
...
func _init() -> void:
	...
	if err != OK:
		...
		quit(1)
		return
	err = ResourceSaver.save(packed, "res://flora/plants_placed.tscn")
