# Research: Puzzle ideas

Ideas for puzzles that teach the player something about Japan. Working
premise (see README): the world was created to commemorate Japan, and the
builder left puzzles to solve.

## Torii gate puzzle

A torii (鳥居, とりい) is a traditional Japanese gate that usually marks the
entrance to a Shinto shrine. It symbolically separates the ordinary human
world from sacred space associated with the kami—Shinto deities or
spirits.[wikipedia]

The spelling is torii, not usually "tori gate." A torii generally has two
upright posts and horizontal beams, and may be made of wood, stone, or
concrete. Many are painted vermilion, though black, natural wood, and
other forms also exist.

**Puzzle sketch:** a vermilion torii stands on the island as the visual
language for "sacred space / puzzle here." The gate only opens once the
player has found three glow plants whose seasonal words (kigo, 季語) match
